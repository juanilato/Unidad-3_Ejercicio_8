...
class ManejaPersonal:
    ...
    def gastoSueldoPorEmpleado(self, cuil):
        for dato in self:
            if dato.getCuil() == cuil:
                print(str(dato.getSueldo()))
